...
# basic stuff
sudo dnf --assumeyes remove gnome-classic-session gnome-boxes gnome-software cheese gnome-tour gnome-maps yelp rhythmbox simple-scan gnome-characters gnome-font-viewer gnome-weather gnome-text-editor gnome-logs gnome-contacts gnome-connections gnome-abrt mediawriter
