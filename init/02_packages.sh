...

{
    ...
    # uninstall bloat
    sudo dnf --assumeyes remove plasma-discover plasma-welcome plasma-vault plasma-drkonqi im-chooser kaddressbook kontact kde-connect kgpg ktnef kmines kmahjongg kmail kmousetool krdc kmouth akregator gnome-abrt dragon elisa-player neochat krdc korganizer krfb khelpcenter skanpage kpat kfind mediawriter kamoso kcharselect kolourpaint spectacle nwg-panel libreport kitty
