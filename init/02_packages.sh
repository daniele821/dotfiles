...

{
	...
	sudo dnf --assumeyes install neovim gcc fd-find ripgrep zoxide bat lsd tldr libreoffice-langpack-it wireshark mpv libsixel-utils jq hyprland gammastep waybar swaylock brightnessctl
