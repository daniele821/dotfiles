...

{
    ...
    sudo dnf --assumeyes install neovim gcc fd-find ripgrep zoxide bat lsd tldr libreoffice-langpack-it wireshark mpv libsixel-utils starship jq hyprland gammastep waybar swaylock brightnessctl
