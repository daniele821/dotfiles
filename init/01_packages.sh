...
sudo zypper install --no-confirm hyprland hyprpaper waybar ripgrep kitty neovim vim git lsd starship NetworkManager-applet bat nodejs-common zoxide fzf ShellCheck libnotify gcc libqt5-qtwayland qt6-wayland
